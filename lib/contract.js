...
export const TRUTHGATE_ABI = [
  {
    inputs: [
      ...
      { internalType: "string", name: "startupIdea", type: "string" },
    ],
    ...
    outputs: [
      {
        components: [
          ...
          { internalType: "string", name: "aiVerdict", type: "string" },
...
export const ANALYSIS_MESSAGES = [
  ...
  "Generating founder profile...",
  "Running AI founder evaluation...",
  "Generating Truth Score...",
  "Finalizing verdict...",
];

/**
 * Run the full GitHub + portfolio + founder analysis in a single payable tx.
 *
 * @param {object} args
 * @param {import("ethers").Signer} args.signer
 * @param {string} args.username
 * @param {string} args.portfolioUrl
 * @param {string} args.startupIdea
...
export async function runGithubAnalysis({
  ...
  const tx = await contract.analyzeCompleteProfile(
    username,
    portfolioUrl,
    startupIdea,
 ...
 * @property {string} startupIdea        Founder's submitted startup idea
 ...
 * @property {string} aiVerdict          AI founder evaluation (long text)
 * @property {number} followers
 * @property {number} following
 * @property {number} publicRepos
 * @property {number} aiScore            Raw AI score
 * @property {number} truthScore         Final trust score (primary signal)
