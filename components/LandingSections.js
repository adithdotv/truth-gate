...
// The TruthGate story — rendered on the home page below the hero.
const PROBLEMS = [
  {
...
const TECH = ["Somnia", "Solidity", "Next.js", "ethers.js", "AI Agents", "GitHub API"];
...
function SectionHeading({ children }) {
  return (
    <h2 className="font-display text-3xl leading-tight sm:text-5xl">{children}</h2>
  );
}
...
export default function LandingSections() {
  return (
    <>
      ...
      {/* ════════ HOW IT WORKS ════════ */}
      <section id="how-it-works" className="mx-auto w-full max-w-3xl scroll-mt-24 px-6 py-24">
        <Reveal className="flex flex-col items-center gap-4 text-center">
        ...
        <div className="relative mx-auto w-full max-w-5xl">
          <Reveal className="flex flex-col items-center gap-4 text-center">
            ...
            <p className="max-w-2xl text-muted">
              ...
              request fans out to a validator subcommittee that reaches consensus
              before anything is written to chain.
            </p>
          </Reveal>
      ...
      <section className="mx-auto w-full max-w-5xl px-6 py-24">
        <Reveal className="flex flex-col items-center gap-4 text-center">
          ...
          <p className="max-w-2xl text-muted">
            Reputation is the missing primitive of the open web. TruthGate is the
            first layer where it becomes provable, portable, and yours.
          </p>
        </Reveal>
        ...
        <div className="mt-14 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {VISION.map((v, i) => (
            <Reveal key={v.title} delay={i * 80}>
              <div className={`${CARD} h-full`}>
                <h3 className="font-display text-lg text-glow-emerald">{v.title}</h3>
      ...
      <section className="relative overflow-hidden px-6 py-32">
        ...
        <Reveal className="relative z-10 mx-auto flex max-w-2xl flex-col items-center gap-6 text-center">
          ...
          <p className="max-w-md text-lg text-muted">
            Step through the gate. Let the autonomous agents render their verdict
            — and mint your Truth Score on Somnia.
          </p>
          <Link
            href="/submit"
